...
contract TokenERC20 is owned{
    ...
    // This notifies clients about a new selling order
    event CreateOrder(address indexed owner, uint256 amount, uint256 price);
    ...
    /**
     * Divident claiming for any token owner
     */ 
    function claimDividends() public{
        require(balanceOf[msg.sender] > 0);
        uint amount = (balanceOf[msg.sender] * dividends) / totalSupply;
